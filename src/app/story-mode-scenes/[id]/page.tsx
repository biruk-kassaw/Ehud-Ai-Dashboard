...
export default function SceneDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="border-b border-gray-200 py-3 px-4 sm:px-6 flex justify-between items-center bg-white">
              <h1 className="text-lg font-medium text-gray-900">Escape</h1>
              <div className="flex items-center gap-2 sm:gap-4">
                <Link href="/my-projects">
                    <button className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-1.5 border border-gray-200 rounded-md hover:bg-gray-50 text-xs sm:text-sm font-medium cursor-pointer">
                        <Folder className="w-4 h-4 mr-0 sm:mr-1 text-gray-500"/>
                        <span className="hidden xs:inline">My Projects</span>
                    </button>
                </Link> 
                <div className="hidden sm:flex text-xs font-normal bg-gray-200 px-2 py-1 rounded-sm">
      ...
      {/* Breadcrumb */}
      <div className="px-4 sm:px-6 py-4 sm:py-6 flex items-center gap-2 text-sm">
        ...
        <div className="mx-4 sm:mx-6 p-3 sm:p-4 bg-black text-white rounded-lg flex flex-col sm:flex-row sm:items-center justify-between">
          <div className="flex items-center">
            <span className="font-medium mr-2">Scene {scene.id}</span>
            <span className="text-sm sm:text-base">{scene.title}</span>
          </div>
        </div>
      ...
      <div className="px-4 sm:px-6 py-4">
        {/* Scene description */}
        <div className="py-4 sm:py-6 mb-6 flex flex-col md:flex-row gap-4 sm:gap-8">
            <div className="w-full md:w-1/2">
                <h2 className="font-bold mb-2 text-xl sm:text-2xl">Scene Description</h2>
                <p className="text-gray-700 mb-4 sm:mb-6">{scene.description}</p>
            </div>

            <div className="w-full md:w-1/2">
                <h1 className="font-bold mb-2 text-xl sm:text-2xl">Scene Details</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 mb-6">
          <div className="col-span-1 lg:col-span-3 overflow-x-auto border rounded-lg">
            <table className="w-full border-collapse p-2 min-w-[600px]">
              <thead>
                ...
                {scene.shots.map((shot, index) => (
                  <tr key={shot.id} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                    ...
                    <td className="py-3 px-4 border-t border-gray-200">
                      <button className={`px-2 py-1 text-xs rounded bg-black text-white ${shot.status === 'In Progress' ? 'min-w-[80px]' : ''}`}>
                        {shot.status}
                      </button>
                    </td>
                    <td className="py-3 px-4 border-t border-gray-200">
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4">
                  ...
                  <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                    <div className="py-2">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 gap-y-4 mt-6">
                        {/* Row 1 */}
                ...
                <div className="p-4">
                    <div className="relative aspect-video w-full overflow-hidden rounded-md">
                        ...
                        />
                        <button className="absolute top-1 sm:top-2 right-1 sm:right-2 bg-black/50 text-white p-1 rounded-full">
        ...
        {/* Timeline */}
        <div className="mt-6 sm:mt-8 border border-gray-200 rounded-lg overflow-hidden p-3 sm:p-4">
          ...
          <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
            <div className="w-12 sm:w-16 h-12 sm:h-16 bg-gray-100 flex items-center justify-center border-r border-gray-200">
              <span className="text-xs text-gray-500">Video</span>
            </div>
            <div className="flex-1 overflow-x-auto">
              <div className="flex">
                <div className="min-w-[120px] sm:min-w-[160px] h-12 sm:h-16 relative">
                  <Image 
                    src="/generate/g1.png" 
                    alt="Shot 1" 
                    fill
                ...
                {[2, 3, 4, 5, 6].map(id => (
                  <div key={id} className="min-w-[120px] sm:min-w-[160px] h-12 sm:h-16 bg-gray-200 flex items-center justify-center border-l border-gray-300">
