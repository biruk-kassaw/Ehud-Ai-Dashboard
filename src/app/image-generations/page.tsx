      ...
      <header className="">
        ...
        <div className="grid grid-cols-2 border-b">
          ...
          <div className="flex justify-between items-center px-6 py-2">
            <h2 className="text-lg font-medium">Scene Image Creator</h2>
            <div className="flex items-center gap-2">
            ...
            <div className="space-y-4 border rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-4 px-4">
                <div className="relative group">
                  ...
                  <Image src="/generate/g1.png" alt="Generated scene 1" width={400} height={300} className="w-full rounded-lg" />
                </div>
                <div className="relative">
                  <Image src="/generate/g2.png" alt="Generated scene 2" width={400} height={300} className="w-full rounded-lg" />
                </div>
              </div>
